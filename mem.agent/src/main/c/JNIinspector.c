...
#include "net_mjahn_mem_agent_VMInspector.h"
 ...
 */
JNIEXPORT jlong JNICALL Java_net_mjahn_mem_agent_VMInspector_getSizeOfAllLoadedObjectsBy
 ...
 */
JNIEXPORT jobjectArray JNICALL Java_net_mjahn_mem_agent_VMInspector_getAllLoadedObjectsOf
  (JNIEnv * env, jobject cl, jobject classLoader){
    // FIXME: implementent this!
    return 0;
}
 ...
 */
JNIEXPORT jobjectArray JNICALL Java_net_mjahn_mem_agent_VMInspector_getAllClassLoadersOfType
 ...
 */
JNIEXPORT jobjectArray JNICALL Java_net_mjahn_mem_agent_VMInspector_getAllClassLoaders
