...
#include "net_mjahn_mem_agent_MemAgent.h"
...
/*
 * Class:     net_mjahn_agent_inspector_MemAgent
 * Method:    getSizeOfAllLoadedObjectsBy
 * Signature: (Ljava/lang/ClassLoader;)J
 */
JNIEXPORT jlong JNICALL Java_net_mjahn_mem_agent_MemAgent_getSizeOfAllLoadedObjectsBy
 ...
 */
JNIEXPORT jobjectArray JNICALL Java_net_mjahn_mem_agent_MemAgent_getAllLoadedObjectsOf
  (JNIEnv * env, jobject cl, jobject classLoader){
    // FIXME: implementent this!
    return 0;
}
 ...
 */
JNIEXPORT jobjectArray JNICALL Java_net_mjahn_mem_agent_MemAgent_getAllClassLoadersOfType
 ...
 */
JNIEXPORT jobjectArray JNICALL Java_net_mjahn_mem_agent_MemAgent_getAllClassLoaders
